...
public class BookEntityRepositoryIntegrationTests {
    ...
    public void testThatMultipleBooksCanBeCreatedAndRecalled() {
        AuthorEntity authorEntity = TestDataUtil.createTestAuthorEntityA(); // Single author for all books
    ...
    public void testThatBookCanBeUpdated() {
        ...
        underTest.save(bookEntityA); // gets the isbn from the book object
